...
//        };
        String[] tableNamesAdmin =
        {"data_adcp","data_biochemistry","data_ctd","data_meteorology","rc_basic_cruise_info",
                "rc_basic_cruise_project_info","rc_basic_cruise_segment_info",
                "rc_basic_cruise_stance_info","station_adcp","station_meteorology"
        };
    ...
    private static void shell(String tableName){
        ...
        gc.setOutputDir(path+"\\out\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/nsfc?useUnicode=true&characterEncoding=utf8&autoReconnect=true&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&useSSL=false");
